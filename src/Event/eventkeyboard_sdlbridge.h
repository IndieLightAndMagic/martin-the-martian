...
namespace GTech{
    ...
    namespace KeyboardEvent{
        map<KBEvent, Uint32> SDLGTechMap;
        // = {{KBEvent::KEY_PRESSED, SDL_KEYDOWN}, {KBEvent::KEY_RELEASED, SDL_KEYUP}}
        map<Uint32, KBEvent> GTechSDLMap;
        // = {{SDL_KEYDOWN, KBEvent::KEY_PRESSED}, {SDL_KEYUP, KBEvent::KEY_RELEASED}}
    }
    namespace KeyboardKey{
        map<KBKey, Sint32> GTechSDLMap;/*{
